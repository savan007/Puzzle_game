...
public class tictac {
	...
	private char mBoard[];
	private final static int BORD_SIZE=9;
	...
	public static int getBORD_SIZE()
	{
		return BORD_SIZE;
	}
	...
	public int getComputerMove()
	{
		...
		do{
			move = mRand.nextInt(getBORD_SIZE());
